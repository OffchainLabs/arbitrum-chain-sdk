...
ARBITRUM_TESTNODE_VERSION="${ARBITRUM_TESTNODE_VERSION:-v0.2.12}"
INTEGRATION_TEST_DECIMALS="${INTEGRATION_TEST_DECIMALS:-20}"
INTEGRATION_TEST_NITRO_CONTRACTS_BRANCH="${INTEGRATION_TEST_NITRO_CONTRACTS_BRANCH:-v2.1}"
...
TESTNODE_IMAGE="${TESTNODE_IMAGE:-ghcr.io/offchainlabs/arbitrum-testnode-ci:${ARBITRUM_TESTNODE_VERSION}-nc${NITRO_CONTRACTS_VERSION}-${TESTNODE_VARIANT}}"
